...
# calculations. The end result of calling this script might be a newly spawned webserver.
# Author: Peter Winter
# Date: 12/01/2017
########################################################################################
# License Agreement:
...
then
    ...
    /bin/echo "${0} `/bin/date`: Performing dead or alive from cron" >> ${HOME}/logs/MonitoringLog.log
